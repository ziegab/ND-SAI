...
# Fit the model
lasso_model.fit(input_train, label_train)
ridge_model.fit(input_train, label_train)

# Make predictions on the test set
label_pred = ridge_model.predict(input_train)
label_pred_val = ridge_model.predict(input_val)
...
for i,input in enumerate(input_trains):
    predictions_norm = ridge_model.predict(input)
